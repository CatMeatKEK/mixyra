local PudgeExtended = {}
PudgeExtended.RotEnabled = Menu.AddOption({ "Hero Specific", "Pudge", "Rot farm" }, "Enabled", "Try to deny creep with Rot")
PudgeExtended.RotHP = Menu.AddOption({ "Hero Specific", "Pudge", "Rot farm" }, "HP Threshold", "Use only when HP more than", 0, 1000, 50)
...
PudgeExtended.Suicide = Menu.AddOption({ "Hero Specific", "Pudge" }, "Suicide", "Trying to commit suicide")
